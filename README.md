...
To auto compile sass in dev environment
...
- API keys to auto retrieve Instagram posts
- Color scheme and theme
- Button transitions on hover
- Does the client want each past event to have a unique page, or a is a single collection okay
- Highlighted performer desired photos and bios
- Prefered contact email for form
- Does the client have a logo/icon they wish to use on the site
- Review all photos for approval
